      ...
      <div className="min-h-screen bg-white text-text1 font-sans">
        <section className="pt-6 pb-16 px-6 lg:pb-24 lg:px-20">
          <div className="container mx-auto max-w-6xl">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold uppercase tracking-wide text-[#32753A] mb-3">
              {t('farmePolicy.heroTitle')}
            </h1>
            <div className="flex gap-2 w-full max-w-md mb-10 md:mb-12">
              <span className="h-1 flex-1 rounded-full bg-[#32753A]" />
            ...
            <div className="flex flex-col lg:flex-row lg:items-stretch gap-10 lg:gap-0">
              <div className="w-full lg:w-[34%] shrink-0">
                <div className="rounded-2xl overflow-hidden border border-[#32753A]/25 shadow-md h-full min-h-[260px] lg:min-h-[420px] bg-[#32753A]/10">
                  <img
                    src="/DSC06501.jpg"
                    alt=""
              ...
              <div
                ...
                aria-hidden
              >
                <div className="absolute top-8 bottom-8 left-1/2 w-px -translate-x-1/2 bg-[#32753A]/35" />
              </div>
              ...
              <div className="flex-1 min-w-0 space-y-10 lg:space-y-12 lg:pl-2 border-t border-[#e5e7eb] pt-10 lg:border-t-0 lg:pt-0">
                {POLICY_BLOCKS.map((block) => (
                  <div key={block.num} className="flex gap-4 sm:gap-5">
                    <div className="flex-shrink-0 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#32753A] text-white flex items-center justify-center text-xs sm:text-sm font-bold tracking-tight">
                      {block.num}
                    </div>
                    <div className="min-w-0 flex-1">
                      <h2 className="text-lg sm:text-xl font-bold text-[#32753A] mb-1 leading-snug">
                        {t(block.titleKey)}
                      </h2>
                      {block.noteKey ? (
